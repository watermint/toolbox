...
type MsgReportingGuide struct {
	DocDesc app_msg.Message
	Title   app_msg.Message
}

var (
	MReportingGuide = app_msg.Apply(&MsgReportingGuide{}).(*MsgReportingGuide)
)

type ReportingGuide struct {
}

func (z *ReportingGuide) DocId() dc_index.DocId {
	return dc_index.DoCSupplementalReportingOptions
}

func (z *ReportingGuide) DocDesc() app_msg.Message {
	return MReportingGuide.DocDesc
}

func (z *ReportingGuide) Sections() []dc_section.Section {
...
func (z *ReportingSection) Title() app_msg.Message {
	return MReportingGuide.Title
}

func (z *ReportingSection) Body(ui app_ui.UI) {
	ui.Info(app_msg.Raw(`
