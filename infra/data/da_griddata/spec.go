...
func (z rdSpec) Desc() app_msg.Message {
	return app_msg.CreateMessage(es_reflect.Key(z.recipe) + ".grid_data_input." + es_case.ToLowerSnakeCase(z.name) + ".desc")
}
...
func (z wrSpec) Desc() app_msg.Message {
	return app_msg.CreateMessage(es_reflect.Key(z.recipe) + ".grid_data_output." + es_case.ToLowerSnakeCase(z.name) + ".desc")
}
