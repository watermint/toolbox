...
func (z *ValueDbxConnBusinessFile) ErrorHandler() rc_error_handler.ErrorHandler {
...
func (z *ValueDbxConnBusinessFile) Accept(recipe interface{}, t reflect.Type, v0 interface{}, name string) rc_recipe.Value {
