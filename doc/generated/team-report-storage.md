...
```
cd $HOME\Desktop
.\tbx.exe team report storage 
```

macOS, Linux:

```
$HOME/Desktop/tbx team report storage 
```
...
Storage usage report The command will generate a report in three different formats. `report.csv`, `report.json`,
and `report.xlsx`.
