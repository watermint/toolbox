...
custom "from" address. The command will generate a report in three different formats. `send_as.csv`, `send_as.json`,
and `send_as.xlsx`.
...
follows; `send_as_0000.xlsx`, `send_as_0001.xlsx`, `send_as_0002.xlsx`, ...
