...
```
cd $HOME\Desktop
.\tbx.exe team report membership 
```

macOS, Linux:
```
$HOME/Desktop/tbx team report membership 
```
...
Membership report The command will generate a report in three different formats. `report.csv`, `report.json`,
and `report.xlsx`.
...
follows; `report_0000.xlsx`, `report_0001.xlsx`, `report_0002.xlsx`, ...
