...
```
cd $HOME\Desktop
.\tbx.exe team report activity 
```

macOS, Linux:
```
$HOME/Desktop/tbx team report activity 
```
...
Activity report The command will generate a report in three different formats. `report.csv`, `report.json`,
and `report.xlsx`.
