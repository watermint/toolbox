...
```
cd $HOME\Desktop
.\tbx.exe team report devices 
```

macOS, Linux:
```
$HOME/Desktop/tbx team report devices 
```
...
Devices report The command will generate a report in three different formats. `report.csv`, `report.json`,
and `report.xlsx`.
