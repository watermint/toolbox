...
Google Spreadsheet The command will generate a report in three different formats. `sreadsheet.csv`, `sreadsheet.json`,
and `sreadsheet.xlsx`.
...
follows; `sreadsheet_0000.xlsx`, `sreadsheet_0001.xlsx`, `sreadsheet_0002.xlsx`, ...
