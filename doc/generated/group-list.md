...
Command result report files are generated in `group.csv`, `group.xlsx` and `group.json` format.
Report in `.xlsx` format will be split into several chunks like `group_0000.xlsx`, `group_0001.xlsx`, and `group_0002.xlsx`.   
