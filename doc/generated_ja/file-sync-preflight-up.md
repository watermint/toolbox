...
```
cd $HOME\Desktop
.\tbx.exe file sync preflight up -dropbox-path /DROPBOX/PATH/TO/UPLOAD -local-path /LOCAL/PATH/OF/CONTENT
```

macOS, Linux:
```
$HOME/Desktop/tbx file sync preflight up -dropbox-path /DROPBOX/PATH/TO/UPLOAD -local-path /LOCAL/PATH/OF/CONTENT
```
