...
このコマンドはレポートを3種類の書式で出力します. `rows.csv`, `rows.json`, ならびに `rows.xlsx`.
...
レポートが大きなものとなる場合、`.xlsx`フォーマットのファイルは次のようにいくつかに分割されて出力されます; `rows_0000.xlsx`, `rows_0001.xlsx`, `rows_0002.xlsx`, ...
