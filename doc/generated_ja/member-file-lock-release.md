...
Release the lock of the path of the member
...
```
cd $HOME\Desktop
.\tbx.exe member file lock release -path /DROPBOX/PATH/TO/RELEASE/LOCK
```

macOS, Linux:

```
$HOME/Desktop/tbx member file lock release -path /DROPBOX/PATH/TO/RELEASE/LOCK
```
