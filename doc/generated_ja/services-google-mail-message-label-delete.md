...
```
cd $HOME\Desktop
.\tbx.exe services google mail message label delete 
```

macOS, Linux:
```
$HOME/Desktop/tbx services google mail message label delete 
```
...
| `-peer`       | アカウントの別名                                                                            | &{default [https://www.googleapis.com/auth/gmail.modify] <nil>} |
