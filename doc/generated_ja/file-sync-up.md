...
{"key":"recipe.file.sync.up.title","params":{}}
...
| オプション      | 説明                                                           | デフォルト |
|-----------------|----------------------------------------------------------------|------------|
| `-dropbox-path` | {"key":"recipe.file.sync.up_vo.flag.dropbox_path","params":{}} |            |
| `-local-path`   | {"key":"recipe.file.sync.up_vo.flag.local_path","params":{}}   |            |
| `-peer`         | {"key":"recipe.file.sync.up_vo.flag.peer","params":{}}         | {default}  |
