...
フォルダを他のメンバーの個人フォルダに複製します (非可逆な操作です)

このコマンドは、コピー元フォルダ以下のファイルをコピー先フォルダに複製します. ソース フォルダは、ソース メンバーの個人フォルダ、共有フォルダ、またはチーム フォルダのいずれかになります.
しかし、それはマウントされ、アクセス可能でなければなりません. このコマンドは、保存先のパスに既にファイルが存在する場合に、ファイルを上書きします.
このコマンドは、転送元メンバー内のコピー元パスからコピー先メンバー内の転送先パスへの一方向コピーです. つまり、このコマンドは、ソースパス上で削除されたファイルを、コピー先パス上では削除しないということです.
...
```
cd $HOME\Desktop
.\tbx.exe member folder replication -dst-path /コピー先パス -src-path /コピー元パス -dst-member-email コピー先メンバーのメールアドレス -src-member-email コピー元メンバーのメールアドレス
```

macOS, Linux:
```
$HOME/Desktop/tbx member folder replication -dst-path /コピー先パス -src-path /コピー元パス -dst-member-email コピー先メンバーのメールアドレス -src-member-email コピー元メンバーのメールアドレス
```
...
| オプション          | 説明                                                                                                                                       | デフォルト |
|---------------------|--------------------------------------------------------------------------------------------------------------------------------------------|------------|
| `-dst-member-email` | コピー先チームメンバーのメールアドレス                                                                                                     |            |
| `-dst-path`         | コピー先チームメンバーのパス. ルート (/) パスは許可されていないことに注意してください. ルート以下の任意のフォルダを選択する必要があります. |            |
| `-peer`             | アカウントの別名                                                                                                                           | default    |
| `-src-member-email` | 送信元チームメンバーのメールアドレス.                                                                                                      |            |
| `-src-path`         | コピー元メンバーのパス                                                                                                                     |            |
