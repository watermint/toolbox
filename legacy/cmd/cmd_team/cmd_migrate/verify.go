...
type CmdTeamMigrateVerify struct {
...
func (z *CmdTeamMigrateVerify) Name() string {
	return "verify"
}

func (z *CmdTeamMigrateVerify) Desc() string {
	return "cmd.team.migrate.verify.desc"
}

func (z *CmdTeamMigrateVerify) Usage() func(cmd2.CommandUsage) {
	return nil
}

func (z *CmdTeamMigrateVerify) FlagConfig(f *flag.FlagSet) {
...
func (z *CmdTeamMigrateVerify) Exec(args []string) {
	var err error
