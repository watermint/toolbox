...
func (*CommandletBase) PrintUsage(ec *app2.ExecContext, clt Commandlet) {
	var c Commandlet
	cmds := make([]string, 0)
	c = clt
	for c != nil {
...
func (z *SimpleCommandlet) Setup(ec *app2.ExecContext) {
	z.ExecContext = ec
}
...
func (z *CommandletGroup) Setup(ec *app2.ExecContext) {
	z.ExecContext = ec
}
