...
func Recipes() []infra_recipe_rc_recipe.Recipe {
	cat := []infra_recipe_rc_recipe.Recipe{
		...
		infra_recipe_rc_recipe.Annotate(&recipeservicesgithubreleaseasset.Download{}, infra_recipe_rc_recipe.Console(), infra_recipe_rc_recipe.Experimental()),
		infra_recipe_rc_recipe.Annotate(&recipeservicesgithubreleaseasset.Upload{}, infra_recipe_rc_recipe.Console(), infra_recipe_rc_recipe.Experimental()),
