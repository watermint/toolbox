...
func (z *Activity) Preset() {
	z.Report.SetModel(&mo_team.Activity{})
	z.Peer.SetScopes(
		dbx_auth.ScopeTeamInfoRead,
	)
}

func (z *Activity) Exec(c app_control.Control) error {
	...
	z.Report.Row(&activity)
	return nil
}

func (z *Activity) Test(c app_control.Control) error {
	return rc_exec.ExecMock(c, &Activity{}, rc_recipe.NoCustomValues)
}
