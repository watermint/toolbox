...
func (z fileImpl) FilePutText(path efs_base.Path, data string, opts ...TextOpt) efs_base.FsError {
...
func (z fileImpl) FileGetText(path efs_base.Path, opts ...TextOpt) (data string, fsError efs_base.FsError) {
	//TODO implement me
	panic("implement me")
}

func (z fileImpl) FileGetTextLine(path efs_base.Path, handler func(line string) bool, opts TextOpt) efs_base.FsError {
	//TODO implement me
	panic("implement me")
}
