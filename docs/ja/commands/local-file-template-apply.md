---
layout: command
title: コマンド `local file template apply`
lang: ja
---

# local file template apply

ファイル/フォルダー構造のテンプレートをローカルパスに適用する 
...
macOS, Linux:
```
$HOME/Desktop/tbx local file template apply -path /LOCAL/PATH/TO/APPLY -template /LOCAL/PATH/TO/template.json
```
