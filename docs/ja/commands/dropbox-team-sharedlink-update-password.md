---
layout: command
title: コマンド `dropbox team sharedlink update password`
lang: ja
---
...
既存の共有リンクにパスワード保護を適用するか、現在のパスワードを更新します。外部で共有される機密コンテンツを保護するために重要です。脆弱なリンクをターゲットにしたり、コンテンツの機密性に基づいてパスワードを適用したりできます。リンクの受信者に新しい要件を通知します。
