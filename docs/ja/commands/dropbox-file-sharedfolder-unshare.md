---
layout: command
title: コマンド `dropbox file sharedfolder unshare`
lang: ja
---
...
フォルダの共有を停止し、オプションで現在のメンバーにコピーを残します。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file sharedfolder unshare -path /DROPBOX/PATH/TO/UNSHARE
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file sharedfolder unshare -path /DROPBOX/PATH/TO/UNSHARE
```
