---
layout: command
title: コマンド `dropbox file sharedlink delete`
lang: ja
---

# dropbox file sharedlink delete

共有リンクを削除します (非可逆な操作です)
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file sharedlink delete -path /path/to/delete
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file sharedlink delete -path /path/to/delete
```
...
**-path**
: 共有リンクを削除するファイルまたはフォルダへのパス

**-peer**
: アカウントの別名. Default: default

**-recursive**
: フォルダ階層をたどって削除します. Default: false
