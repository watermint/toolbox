---
layout: command
title: コマンド `dropbox file request create`
lang: ja
---
...
macOS, Linux:
```
$HOME/Desktop/tbx dropbox file request create -path /DROPBOX/PATH/OF/FILE_REQUEST -title TITLE
```
...
**-allow-late-uploads**
: 設定した場合、期限を過ぎてもアップロードを許可します (one_day/two_days/seven_days/thirty_days/always)
