...
```
cd $HOME\Desktop
.\tbx.exe dev build info -file-path /LOCAL/PATH/TO/SAVE/info.json
```

macOS, Linux:
```
$HOME/Desktop/tbx dev build info -file-path /LOCAL/PATH/TO/SAVE/info.json
```
