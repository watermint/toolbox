---
layout: command
title: コマンド `dropbox file sharedfolder member delete`
lang: ja
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file sharedfolder member delete -email EMAIL -path /DROPBOX/PATH/TO/DELETE
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file sharedfolder member delete -email EMAIL -path /DROPBOX/PATH/TO/DELETE
```
