---
layout: command
title: コマンド `dropbox team teamfolder batch replication`
lang: ja
---
...
複数のチームフォルダを完全な構造と権限とともにコピーを作成します。バックアップの作成、並列環境の設定、または移行の準備に便利です。大規模なレプリケーションの前にストレージへの影響を検討してください。
