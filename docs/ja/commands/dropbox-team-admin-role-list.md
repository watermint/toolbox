---
layout: command
title: コマンド `dropbox team admin role list`
lang: ja
---

# dropbox team admin role list

チームで利用可能なすべての管理者ロールとその説明・権限を表示 

Dropboxチームで利用可能なすべての管理者ロールとその機能を一覧表示します。ロールを割り当てる前に参照して、権限の影響を理解してください。チームメンバーが適切なアクセスレベルを受け取ることを確実にするのに役立ちます。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox team admin role list 
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox team admin role list 
```
