---
layout: command
title: コマンド `dropbox team admin list`
lang: ja
---

# dropbox team admin list

割り当てられた管理者ロールを持つ全チームメンバーを表示、管理アクセスと権限の監査に有用 

昇格された権限を持つすべてのメンバーを示す包括的な管理者監査レポートを生成します。完全な可視性のために非管理者メンバーを含めることができます。セキュリティレビュー、コンプライアンス監査、組織全体の適切なアクセスレベルの確保に不可欠です。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox team admin list 
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox team admin list 
```
...
**-include-non-admin**
: 管理者以外のメンバーをレポートに含める. Default: false
