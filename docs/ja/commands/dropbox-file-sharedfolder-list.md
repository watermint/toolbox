---
layout: command
title: コマンド `dropbox file sharedfolder list`
lang: ja
---
...
アクセス可能なすべての共有フォルダとその共有詳細をリスト表示します。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file sharedfolder list 
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file sharedfolder list 
```
