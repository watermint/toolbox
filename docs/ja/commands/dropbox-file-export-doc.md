---
layout: command
title: コマンド `dropbox file export doc`
lang: ja
---
...
Dropbox PaperドキュメントとGoogle Docsを指定された形式でローカルファイルにエクスポートします。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file export doc -dropbox-path /DROPBOX/PATH/TO/FILE -local-path /LOCAL/PATH/TO/EXPORT
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file export doc -dropbox-path /DROPBOX/PATH/TO/FILE -local-path /LOCAL/PATH/TO/EXPORT
```
