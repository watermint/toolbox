---
layout: command
title: コマンド `dropbox file lock batch release`
lang: ja
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file lock batch release -file /PATH/TO/DATA_FILE.csv
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file lock batch release -file /PATH/TO/DATA_FILE.csv
```
