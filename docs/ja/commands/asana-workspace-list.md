---
layout: command
title: コマンド `asana workspace list`
lang: ja
---
...
最初の実行では、`tbx`はあなたのAsana (非推奨[#647](https://github.com/watermint/toolbox/discussions/647)参照)
アカウントへの認可を要求します.
...
ワークスペース
このコマンドはレポートを3種類の書式で出力します. `workspaces.csv`, `workspaces.json`, ならびに `workspaces.xlsx`.
...
| name            | ワークスペースの名前。                  |
| is_organization | ワークスペースが組織であるかどうか。           |

`-budget-memory low`オプションを指定した場合、レポートはJSON形式のみで生成されます

レポートが大きなものとなる場合、`.xlsx`フォーマットのファイルは次のようにいくつかに分割されて出力されます;
`workspaces_0000.xlsx`, `workspaces_0001.xlsx`, `workspaces_0002.xlsx`, ...
