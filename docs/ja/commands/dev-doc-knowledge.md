---
layout: command
title: コマンド `dev doc knowledge`
lang: ja
---

# dev doc knowledge

縮小版ナレッジベースの生成 (試験的実装です)

LLMトレーニング用の縮小版ナレッジベースドキュメントを生成します。含まれるコマンド数を制限することで、テストや特定の用途に特化した小さなナレッジベースの作成に便利です。
