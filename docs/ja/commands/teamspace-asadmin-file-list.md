...
チームスペース内のファイルやフォルダーを一覧表示することができます。 
...
| 説明                                                                                              |
|---------------------------------------------------------------------------------------------------|
| Dropbox Business: プロフィール写真など、Dropboxアカウントの基本情報を表示・編集することができます |
...
```
cd $HOME\Desktop
.\tbx.exe teamspace asadmin file list -path /DROPBOX/PATH/TO/LIST
```

macOS, Linux:
```
$HOME/Desktop/tbx teamspace asadmin file list -path /DROPBOX/PATH/TO/LIST
```
