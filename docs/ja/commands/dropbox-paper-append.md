---
layout: command
title: コマンド `dropbox paper append`
lang: ja
---

# dropbox paper append

既存のPaperドキュメントの最後にコンテンツを追加する
...
```
cd $HOME\Desktop
.\tbx.exe dropbox paper append -content /LOCAL/PATH/TO/INPUT.txt -path /DROPBOX/PATH/TO/APPEND.paper
```

macOS, Linux:

```
$HOME/Desktop/tbx dropbox paper append -content /LOCAL/PATH/TO/INPUT.txt -path /DROPBOX/PATH/TO/APPEND.paper
```
