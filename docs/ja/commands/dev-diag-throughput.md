---
layout: command
title: コマンド `dev diag throughput`
lang: ja
---
...
**-bucket**
: バケットサイズ (ミリ秒). Default: 1000

**-endpoint-name**
: エンドポイントによりフィルター. 名前による完全一致でフィルター.

**-endpoint-name-prefix**
: エンドポイントによりフィルター. 名前の前方一致によるフィルター.

**-endpoint-name-suffix**
: エンドポイントによりフィルター. 名前の後方一致によるフィルター.
...
**-time-format**
: 日時フォーマット (Goの日付フォーマット). Default: 2006-01-02 15:04:05.999
