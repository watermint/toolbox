---
layout: command
title: コマンド `util image placeholder`
lang: ja
---
...
```
cd $HOME\Desktop
.\tbx.exe util image placeholder -path /LOCAL/PATH/TO/save.png
```

macOS, Linux:
```
$HOME/Desktop/tbx util image placeholder -path /LOCAL/PATH/TO/save.png
```
...
**-font-path**
: True Typeフォントへのパス（テキストを描画する必要がある場合は必須）
