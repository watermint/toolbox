---
layout: command
title: コマンド `google mail label add`
lang: ja
---

# google mail label add
...
```
cd $HOME\Desktop
.\tbx.exe google mail label add -name NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx google mail label add -name NAME
```
...
| `-color-text`              | テキストの色.                                                                               |            |
| `-label-list-visibility`   | Gmail ウェブインタフェースのラベルリストのラベルの可視性.                                   | labelShow  |
