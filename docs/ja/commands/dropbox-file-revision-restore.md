---
layout: command
title: コマンド `dropbox file revision restore`
lang: ja
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file revision restore -path /DROPBOX/PATH/TO/RESTORE -revision REVISION
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file revision restore -path /DROPBOX/PATH/TO/RESTORE -revision REVISION
```
