---
layout: command
title: コマンド `dropbox team member folder list`
lang: ja
---
...
チームメンバーの個人スペース全体のフォルダを列挙します。フォルダ名でフィルタリングして結果に焦点を当てます。コンテンツの配布の理解、メンバーストレージの監査、移行またはクリーンアップの計画に不可欠です。
...
**-member-email**
: メンバーのメールアドレスでフィルタリングします. メールアドレスでフィルタリングします.
