...
```
cd $HOME\Desktop
.\tbx.exe services figma file info -key FILE_KEY
```

macOS, Linux:
```
$HOME/Desktop/tbx services figma file info -key FILE_KEY
```
...
レポートが大きなものとなる場合、`.xlsx`フォーマットのファイルは次のようにいくつかに分割されて出力されます; `document_0000.xlsx`, `document_0001.xlsx`, `document_0002.xlsx`, ...
...
レポートが大きなものとなる場合、`.xlsx`フォーマットのファイルは次のようにいくつかに分割されて出力されます; `node_0000.xlsx`, `node_0001.xlsx`, `node_0002.xlsx`, ...
