---
layout: command
title: コマンド `dev lifecycle assets`
lang: ja
---
...
GitHub リリースの成果物
このコマンドはレポートを3種類の書式で出力します. `removed.csv`, `removed.json`, ならびに `removed.xlsx`.
...
レポートが大きなものとなる場合、`.xlsx`フォーマットのファイルは次のようにいくつかに分割されて出力されます; `removed_0000.xlsx`, `removed_0001.xlsx`, `removed_0002.xlsx`, ...
