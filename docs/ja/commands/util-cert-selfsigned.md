---
layout: command
title: コマンド `util cert selfsigned`
lang: ja
---
...
```
cd $HOME\Desktop
.\tbx.exe util cert selfsigned -out /LOCAL/PATH/TO/GENERATE_CERT_AND_KEY
```

macOS, Linux:
```
$HOME/Desktop/tbx util cert selfsigned -out /LOCAL/PATH/TO/GENERATE_CERT_AND_KEY
```
