...
| オプション              | 説明                                           | デフォルト |
|--------------------|----------------------------------------------|-------|
| `-full-url`        | 完全なURLを表示する                                  | false |
| `-interval-second` | 時系列の間隔(秒)                                    | 3600  |
| `-name`            | ジョブのコマンドラインパス (例 `dropbox team member list`) |       |
...
`latencies_0000.xlsx`, `latencies_0001.xlsx`, `latencies_0002.xlsx`, ...
...
レポートが大きなものとなる場合、`.xlsx`フォーマットのファイルは次のようにいくつかに分割されて出力されます;
`population_0000.xlsx`, `population_0001.xlsx`, `population_0002.xlsx`, ...
...
レポートが大きなものとなる場合、`.xlsx`フォーマットのファイルは次のようにいくつかに分割されて出力されます;
`time_series_0000.xlsx`, `time_series_0001.xlsx`, `time_series_0002.xlsx`, ...
