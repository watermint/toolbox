...
チームメンバーに対して有効になっている機能と機能を表示します。アクセスの問題のトラブルシューティング、機能のロールアウトの確認、メンバーの機能の理解に便利です。特定のメンバーが特定の機能にアクセスできる理由またはできない理由を特定するのに役立ちます。
...
レポートが大きなものとなる場合、`.xlsx`フォーマットのファイルは次のようにいくつかに分割されて出力されます; `features_0000.xlsx`, `features_0001.xlsx`, `features_0002.xlsx`, ...
