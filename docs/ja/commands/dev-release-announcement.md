---
layout: command
title: コマンド `dev release announcement`
lang: ja
---
...
| オプション          | 説明          | デフォルト                |
|----------------|-------------|----------------------|
| `-category-id` | お知らせカテゴリーID | DIC_kwDOBFqRm84CQesd |
| `-owner`       | レポジトリの所有者   | watermint            |
| `-peer`        | アカウントの別名    | default              |
| `-repository`  | レポジトリ名      | toolbox              |
...
お知らせ
このコマンドはレポートを3種類の書式で出力します. `announcements.csv`, `announcements.json`, ならびに
`announcements.xlsx`.
...
`announcements_0000.xlsx`, `announcements_0001.xlsx`, `announcements_0002.xlsx`, ...
