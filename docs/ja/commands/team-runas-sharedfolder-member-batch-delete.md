...
```
cd $HOME\Desktop
.\tbx.exe team runas sharedfolder member batch delete -file /PATH/TO/DATA_FILE.csv
```

macOS, Linux:
```
$HOME/Desktop/tbx team runas sharedfolder member batch delete -file /PATH/TO/DATA_FILE.csv
```
