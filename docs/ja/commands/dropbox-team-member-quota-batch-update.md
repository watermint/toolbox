---
layout: command
title: コマンド `dropbox team member quota batch update`
lang: ja
---
...
CSVファイルを使用してチームメンバーのストレージクォータを一括更新します。ロール、部門、または使用パターンに基づいてカスタムクォータを設定します。0を使用してカスタムクォータを削除し、チームのデフォルトに戻します。ストレージガバナンスとコスト管理に不可欠です。
...
**-quota**
: カスタムの容量制限 (1TB = 1024GB). 0の場合、容量制限をしません.. Default: 0
