...
| `-executable-name`      | 公開する実行可能ファイルの名前                         | tbx              |
| `-homebrew-repo-branch` | 公開に使用する Homebrew tap リポジトリのブランチです。 | master           |
| `-homebrew-repo-name`   | Homebrew tap リポジトリの名前                          | homebrew-toolbox |
| `-homebrew-repo-owner`  | Homebrew tap リポジトリのオーナー                      | watermint        |
| `-repo-name`            | リリースを公開するリポジトリの名前です。               | toolbox          |
| `-repo-owner`           | リリースを公開するリポジトリの所有者です。             | watermint        |
