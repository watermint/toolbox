---
layout: command
title: コマンド `dev release publish`
lang: ja
---
...
**-executable-name**
: 公開する実行可能ファイルの名前. Default: tbx

**-homebrew-repo-branch**
: 公開に使用する Homebrew tap リポジトリのブランチです。. Default: master

**-homebrew-repo-name**
: Homebrew tap リポジトリの名前. Default: homebrew-toolbox

**-homebrew-repo-owner**
: Homebrew tap リポジトリのオーナー. Default: watermint

**-repo-name**
: リリースを公開するリポジトリの名前です。. Default: toolbox

**-repo-owner**
: リリースを公開するリポジトリの所有者です。. Default: watermint

**-skip-tests**
: エンドツーエンドテストをスキップします.. Default: false
