---
layout: command
title: コマンド `dropbox team group list`
lang: ja
---

# dropbox team group list

メンバー数とグループ管理タイプを含むチーム内の全グループを表示 

サイズと管理モードを示すチームグループの完全なインベントリです。空のグループ、過大なグループ、管理タイプの変更が必要なグループを特定するために使用します。定期的な監査とコンプライアンス文書化のためにエクスポートできます。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox team group list 
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox team group list 
```
