---
layout: command
title: コマンド `dropbox file lock release`
lang: ja
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file lock release -path /DROPBOX/FILE/PATH/TO/UNLOCK
```

macOS, Linux:

```
$HOME/Desktop/tbx dropbox file lock release -path /DROPBOX/FILE/PATH/TO/UNLOCK
```
