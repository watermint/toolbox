...
```
cd $HOME\Desktop
.\tbx.exe teamfolder file lock all release -path /DROPBOX/PATH/TO/RELEASE -team-folder NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx teamfolder file lock all release -path /DROPBOX/PATH/TO/RELEASE -team-folder NAME
```
