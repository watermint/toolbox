...
```
cd $HOME\Desktop
.\tbx.exe util decode base64 -text /LOCAL/PATH/TO/INPUT.txt
```

macOS, Linux:
```
$HOME/Desktop/tbx util decode base64 -text /LOCAL/PATH/TO/INPUT.txt
```
