---
layout: command
title: コマンド `dropbox file lock list`
lang: ja
---
...
現在のユーザーが保持しているすべてのファイルロックを一覧表示します。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file lock list -path /DROPBOX/PATH/TO/SEARCH/LOCK
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file lock list -path /DROPBOX/PATH/TO/SEARCH/LOCK
```
