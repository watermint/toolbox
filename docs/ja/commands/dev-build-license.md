...
```
cd $HOME\Desktop
.\tbx.exe dev build license -dest-path /LOCAL/PATH/TO/PROCESS -source-path /LOCAL/PATH/TO/PROCESS
```

macOS, Linux:

```
$HOME/Desktop/tbx dev build license -dest-path /LOCAL/PATH/TO/PROCESS -source-path /LOCAL/PATH/TO/PROCESS
```
