---
layout: command
title: コマンド `google sheets spreadsheet create`
lang: ja
---
...
Google Spreadsheet
このコマンドはレポートを3種類の書式で出力します. `sreadsheet.csv`, `sreadsheet.json`, ならびに `sreadsheet.xlsx`.
...
レポートが大きなものとなる場合、`.xlsx`フォーマットのファイルは次のようにいくつかに分割されて出力されます; `sreadsheet_0000.xlsx`, `sreadsheet_0001.xlsx`, `sreadsheet_0002.xlsx`, ...
