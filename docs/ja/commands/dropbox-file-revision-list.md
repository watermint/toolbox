---
layout: command
title: コマンド `dropbox file revision list`
lang: ja
---
...
ファイルの利用可能なすべてのリビジョンを変更時刻とサイズとともにリスト表示します。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file revision list -path /DROPBOX/PATH/TO/FILE
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file revision list -path /DROPBOX/PATH/TO/FILE
```
