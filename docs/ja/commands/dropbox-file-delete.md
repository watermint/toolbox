---
layout: command
title: コマンド `dropbox file delete`
lang: ja
---

# dropbox file delete

ファイルまたはフォルダは削除します. (非可逆な操作です)

Dropboxからファイルまたはフォルダを完全に削除します。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file delete -path /PATH/TO/DELETE
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file delete -path /PATH/TO/DELETE
```
