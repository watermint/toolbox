---
layout: command
title: コマンド `dropbox team member file permdelete`
lang: ja
---
...
| Dropbox for teams：メンバーのDropboxファイルとフォルダを永久削除                    |
...
```
cd $HOME\Desktop
.\tbx.exe dropbox team member file permdelete -member-email EMAIL -path /DROPBOX/PATH/TO/DELETE
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox team member file permdelete -member-email EMAIL -path /DROPBOX/PATH/TO/DELETE
```
