---
layout: command
title: コマンド `google calendar event list`
lang: ja
---
...
| 説明                                                |
|-----------------------------------------------------|
| Google Calendar：すべてのカレンダーのイベントを読む |
...
```
cd $HOME\Desktop
.\tbx.exe google calendar event list 
```

macOS, Linux:
```
$HOME/Desktop/tbx google calendar event list 
```
...
レポートが大きなものとなる場合、`.xlsx`フォーマットのファイルは次のようにいくつかに分割されて出力されます; `events_0000.xlsx`, `events_0001.xlsx`, `events_0002.xlsx`, ...
