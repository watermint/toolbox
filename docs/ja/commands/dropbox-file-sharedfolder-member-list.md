---
layout: command
title: コマンド `dropbox file sharedfolder member list`
lang: ja
---
...
共有フォルダのすべてのメンバーとそのアクセスレベル、メールアドレスをリスト表示します。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file sharedfolder member list 
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file sharedfolder member list 
```
