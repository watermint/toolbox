---
layout: command
title: コマンド `dev doc review options`
lang: ja
---
...
レポートが大きなものとなる場合、`.xlsx`フォーマットのファイルは次のようにいくつかに分割されて出力されます; `missing_options_0000.xlsx`, `missing_options_0001.xlsx`, `missing_options_0002.xlsx`, ...
