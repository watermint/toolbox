---
layout: command
title: コマンド `dropbox team legalhold add`
lang: ja
---

# dropbox team legalhold add

新しいリーガル・ホールド・ポリシーを作成する. 
...
```
cd $HOME\Desktop
.\tbx.exe dropbox team legalhold add -member /PATH/TO/member_email.csv -name POLICY_NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox team legalhold add -member /PATH/TO/member_email.csv -name POLICY_NAME
```
...
| `-end-date`    | リーガルホールド・ポリシーの終了日.       |            |
| `-member`      | ホールドしたいメンバーのメールアドレス    |            |
| `-name`        | ポリシー名                                |            |
| `-peer`        | アカウントの別名                          | default    |
| `-start-date`  | リーガルホールド・ポリシーの開始日.       |            |
...
| 列    | 説明                            | 例               |
|-------|---------------------------------|------------------|
| email | チームメンバーのメールアドレス. | emma@example.com |
