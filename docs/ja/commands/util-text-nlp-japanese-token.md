---
layout: command
title: コマンド `util text nlp japanese token`
lang: ja
---
...
**-dictionary**
: トークンの辞書名. Options: ipa (辞書: ipa), uni (辞書: uni). Default: ipa

**-ignore-line-break**
: 改行を無視する. Default: false

**-in**
: 入力ファイルのパス

**-mode**
: トークン化モード(normal/search/extended). Options:.   • normal (モード: normal).   • search (モード: search).   • extend (モード: extend). Default: normal

**-omit-bos-eos**
: BOS/EOSトークンの省略. Default: false
