...
```
cd $HOME\Desktop
.\tbx.exe team admin group role delete -exception-group GROUP_NAME -role-id ROLE_ID
```

macOS, Linux:
```
$HOME/Desktop/tbx team admin group role delete -exception-group GROUP_NAME -role-id ROLE_ID
```
