---
layout: command
title: コマンド `dropbox team filesystem`
lang: ja
---

# dropbox team filesystem

チームのファイルシステムのバージョンを特定する 

機能の利用可能性とAPIの動作に影響する基礎となるファイルシステムのバージョンを決定します。最新のファイルシステムは、ネイティブPaperやパフォーマンスの向上などの高度な機能を有効にします。レガシーチームは完全な機能アクセスのために移行が必要な場合があります。
