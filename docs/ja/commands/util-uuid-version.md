...
```
cd $HOME\Desktop
.\tbx.exe util uuid version -uuid UUID
```

macOS, Linux:

```
$HOME/Desktop/tbx util uuid version -uuid UUID
```
...
`metadata_0000.xlsx`, `metadata_0001.xlsx`, `metadata_0002.xlsx`, ...
