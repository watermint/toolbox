---
layout: command
title: コマンド `dropbox team member list`
lang: ja
---

# dropbox team member list

ステータス、ロール、アカウント詳細を含む全チームメンバーの包括的リストを表示 

チーム全体の包括的なメンバーリストを表示し、ステータス、ロール、アカウントの詳細を含みます。メンバー監査、組織構造の理解、アクセス管理の計画に不可欠です。削除されたメンバーも含めることができ、完全な履歴を把握できます。
...
| オプション         | 説明                      | デフォルト |
|--------------------|---------------------------|------------|
| `-include-deleted` | 削除済メンバーを含めます. | false      |
