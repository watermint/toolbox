---
layout: command
title: コマンド `dropbox team content legacypaper list`
lang: ja
---

# dropbox team content legacypaper list

チームメンバーのPaper文書リスト出力 

タイトル、所有者、最終更新日を含むすべてのPaperドキュメントの詳細なインベントリを作成します。コンテンツ監査、孤立したドキュメントの特定、または移行の準備に使用します。作成またはアクセスパターンでフィルタリングして分析に焦点を当てます。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox team content legacypaper list 
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox team content legacypaper list 
```
