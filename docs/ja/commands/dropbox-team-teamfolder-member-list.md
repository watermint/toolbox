---
layout: command
title: コマンド `dropbox team teamfolder member list`
lang: ja
---
...
権限レベルとアクセスが直接かグループ経由かを含む、すべてのチームフォルダの完全なメンバーシップを表示します。アクセス監査、セキュリティレビュー、機密コンテンツにアクセスできる人を理解するために重要です。過剰な権限のアクセスを特定します。
