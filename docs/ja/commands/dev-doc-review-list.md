---
layout: command
title: コマンド `dev doc review list`
lang: ja
---
...
メッセージリソースの確認状況を一覧表示し、未確認のメッセージがどれだけあるかを把握します。言語ごとの確認進捗状況を監視し、翻訳品質管理に役立てます。
