---
layout: command
title: コマンド `util xlsx sheet import`
lang: ja
---
...
```
cd $HOME\Desktop
.\tbx.exe util xlsx sheet import -data /LOCAL/PATH/TO/INPUT.csv -file /LOCAL/PATH/TO/TARGET.xlsx -sheet SHEET_NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx util xlsx sheet import -data /LOCAL/PATH/TO/INPUT.csv -file /LOCAL/PATH/TO/TARGET.xlsx -sheet SHEET_NAME
```
...
**-create**
: 見つからなかった場合はファイルを作成する. Default: false
...
**-position**
: A1表記でのインポート開始位置. デフォルトは `A1` です.. Default: A1
