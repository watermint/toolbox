---
layout: command
title: コマンド `dropbox file lock acquire`
lang: ja
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file lock acquire -path /DROPBOX/FILE/PATH/TO/LOCK
```

macOS, Linux:

```
$HOME/Desktop/tbx dropbox file lock acquire -path /DROPBOX/FILE/PATH/TO/LOCK
```
