...
```
cd $HOME\Desktop
.\tbx.exe member file permdelete -member-email EMAIL -path /DROPBOX/PATH/TO/DELETE
```

macOS, Linux:
```
$HOME/Desktop/tbx member file permdelete -member-email EMAIL -path /DROPBOX/PATH/TO/DELETE
```
