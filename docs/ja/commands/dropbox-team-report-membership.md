---
layout: command
title: コマンド `dropbox team report membership`
lang: ja
---
...
アクティブユーザー、成長傾向、ロール分布を含むメンバーシップ分析を提供します。チームの拡大を追跡し、ライセンス使用量を監視し、非アクティブなアカウントを特定します。予算計画とチームサイズの最適化に便利です。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox team report membership 
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox team report membership 
```
