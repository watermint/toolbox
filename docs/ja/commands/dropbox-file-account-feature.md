---
layout: command
title: コマンド `dropbox file account feature`
lang: ja
---
...
接続されたDropboxアカウントで有効な機能と機能を取得して表示します。
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file account feature 
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file account feature 
```
