---
layout: command
title: コマンド `dropbox team legalhold release`
lang: ja
---
...
リーガルホールドポリシーを終了し、保存要件を削除します。コンテンツは再び通常の保持および削除ポリシーの対象となります。訴訟が終結した場合や保存が不要になった場合に使用します。リリースは監査目的で記録されますが、元に戻すことはできません。
