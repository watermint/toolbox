...
**-job-id-name**
: Filter by job ID name Filter by exact match to the name.

**-job-id-name-prefix**
: Filter by job ID name Filter by name match to the prefix.

**-job-id-name-suffix**
: Filter by job ID name Filter by name match to the suffix.
