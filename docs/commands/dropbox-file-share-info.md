---
layout: command
title: Command `dropbox file share info`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file share info -path /DROPBOX/PATH/TO/GET_INFO
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file share info -path /DROPBOX/PATH/TO/GET_INFO
```
