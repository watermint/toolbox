...
```
cd $HOME\Desktop
.\tbx.exe file tag delete -path /DROPBOX/PATH/TO/TARGET -tag TAG_NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx file tag delete -path /DROPBOX/PATH/TO/TARGET -tag TAG_NAME
```
