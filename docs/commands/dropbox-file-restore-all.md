---
layout: command
title: Command `dropbox file restore all`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file restore all -path /DROPBOX/PATH/TO/RESTORE
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file restore all -path /DROPBOX/PATH/TO/RESTORE
```
