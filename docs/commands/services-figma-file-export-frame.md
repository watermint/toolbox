---
layout: command
title: Command `services figma file export frame`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe services figma file export frame -key FILE_KEY -path /LOCAL/PATH/TO/EXPORT
```

macOS, Linux:
```
$HOME/Desktop/tbx services figma file export frame -key FILE_KEY -path /LOCAL/PATH/TO/EXPORT
```
