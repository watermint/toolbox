---
layout: command
title: Command `google mail message label add`
lang: en
---

# google mail message label add
...
```
cd $HOME\Desktop
.\tbx.exe google mail message label add -label LABEL -message-id MSG_ID
```

macOS, Linux:
```
$HOME/Desktop/tbx google mail message label add -label LABEL -message-id MSG_ID
```
