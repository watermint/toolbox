---
layout: command
title: Command `google mail message send`
lang: en
---

# google mail message send

{"key":"complex","params":{"Messages":[{"K":"citron.google.mail.message.send.title","P":null},{"K":"infra.recipe.rc_spec.msg_self_contained.is_irreversible","P":null}]}}
...
Message resource
The command will generate a report in three different formats. `sent.csv`, `sent.json`, and `sent.xlsx`.
...
In case of a report become large, a report in `.xlsx` format will be split into several chunks like follows; `sent_0000.xlsx`, `sent_0001.xlsx`, `sent_0002.xlsx`, ...
