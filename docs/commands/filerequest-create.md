---
layout: command
title: Command `filerequest create`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe filerequest create -path /DROPBOX/PATH/OF/FILE_REQUEST -title TITLE
```

macOS, Linux:
```
$HOME/Desktop/tbx filerequest create -path /DROPBOX/PATH/OF/FILE_REQUEST -title TITLE
```
