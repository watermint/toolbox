---
layout: command
title: Command `dev doc review approve`
lang: en
---

# dev doc review approve
...
```
cd $HOME\Desktop
.\tbx.exe dev doc review approve 
```

macOS, Linux:
```
$HOME/Desktop/tbx dev doc review approve 
```
...
**-key**
: Message key to approve

**-keys**
: JSON array of message keys to approve
