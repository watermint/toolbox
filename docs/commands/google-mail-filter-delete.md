---
layout: command
title: Command `google mail filter delete`
lang: en
---

# google mail filter delete
...
```
cd $HOME\Desktop
.\tbx.exe google mail filter delete -id ID
```

macOS, Linux:
```
$HOME/Desktop/tbx google mail filter delete -id ID
```
