...
```
cd $HOME\Desktop
.\tbx.exe dev release announcement 
```

macOS, Linux:
```
$HOME/Desktop/tbx dev release announcement 
```
...
**-category-id**
: Announcement category ID. Default: DIC_kwDOBFqRm84CQesd
...
In case of a report becomes large, a report in `.xlsx` format will be split into several chunks like follows; `announcements_0000.xlsx`, `announcements_0001.xlsx`, `announcements_0002.xlsx`, ...
