---
layout: command
title: Command `dropbox sign account info`
lang: en
---

# dropbox sign account info

Show Dropbox Sign account information 
...
In case of a report becomes large, a report in `.xlsx` format will be split into several chunks like follows; `account_0000.xlsx`, `account_0001.xlsx`, `account_0002.xlsx`, ...
