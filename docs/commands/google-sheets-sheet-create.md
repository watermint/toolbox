---
layout: command
title: Command `google sheets sheet create`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe google sheets sheet create -id SPREADSHEET_ID -title TITLE
```

macOS, Linux:
```
$HOME/Desktop/tbx google sheets sheet create -id SPREADSHEET_ID -title TITLE
```
