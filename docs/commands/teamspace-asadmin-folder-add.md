---
layout: command
title: Command `teamspace asadmin folder add`
lang: en
---

# teamspace asadmin folder add

Create top level folder in the team space 
...
```
cd $HOME\Desktop
.\tbx.exe teamspace asadmin folder add -name FOLDER_NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx teamspace asadmin folder add -name FOLDER_NAME
```
