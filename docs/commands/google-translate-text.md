---
layout: command
title: Command `google translate text`
lang: en
---

# google translate text

{"key":"complex","params":{"Messages":[{"K":"citron.google.translate.text.title","P":null},{"K":"raw","P":[{"Raw":""}]}]}}
...
```
cd $HOME\Desktop
.\tbx.exe google translate text -project-id PROJECT_ID -target TARGET_LANG -text /LOCAL/PATH/TO/INPUT.txt
```

macOS, Linux:
```
$HOME/Desktop/tbx google translate text -project-id PROJECT_ID -target TARGET_LANG -text /LOCAL/PATH/TO/INPUT.txt
```
