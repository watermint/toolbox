---
layout: command
title: Command `team sharedlink cap visibility`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe team sharedlink cap visibility -file /PATH/TO/DATA_FILE.csv
```

macOS, Linux:
```
$HOME/Desktop/tbx team sharedlink cap visibility -file /PATH/TO/DATA_FILE.csv
```
