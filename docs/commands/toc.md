...
| [util uuid timestamp]({{ site.baseurl }}/commands/util-uuid-timestamp.html)                                                   | Parse UUID timestamp                                                     |
| [util uuid ulid]({{ site.baseurl }}/commands/util-uuid-ulid.html)                                                             | Generate ULID (Universally Unique Lexicographically Sortable Identifier) |
