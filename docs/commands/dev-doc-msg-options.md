---
layout: command
title: Command `dev doc msg options`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dev doc msg options 
```

macOS, Linux:
```
$HOME/Desktop/tbx dev doc msg options 
```
...
|----------------|---------------------------------------------------------------|---------|
| `-dry-run`     | Show what would be created without actually creating messages | false   |
| `-target-path` | Target path to scan for SelectString fields                   | citron  |
