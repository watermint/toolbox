---
layout: command
title: Command `team admin role add`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe team admin role add -email EMAIL -role-id ROLE_ID
```

macOS, Linux:
```
$HOME/Desktop/tbx team admin role add -email EMAIL -role-id ROLE_ID
```
