---
layout: command
title: Command `team runas sharedfolder mount add`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe team runas sharedfolder mount add -member-email EMAIL -shared-folder-id SHARED_FOLDER_ID
```

macOS, Linux:
```
$HOME/Desktop/tbx team runas sharedfolder mount add -member-email EMAIL -shared-folder-id SHARED_FOLDER_ID
```
