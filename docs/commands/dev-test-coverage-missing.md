---
layout: command
title: Command `dev test coverage missing`
lang: en
---

# dev test coverage missing

Find Missing Tests 

Find files without test coverage and analyze their complexity
...
```
cd $HOME\Desktop
.\tbx.exe dev test coverage missing 
```

macOS, Linux:
```
$HOME/Desktop/tbx dev test coverage missing 
```
...
**-only-missing**
: Show only files without any tests. Default: true

**-package**
: Package to analyze (optional, defaults to entire project)
