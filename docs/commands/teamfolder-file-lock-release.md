---
layout: command
title: Command `teamfolder file lock release`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe teamfolder file lock release -path /DROPBOX/PATH/TO/RELEASE -team-folder NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx teamfolder file lock release -path /DROPBOX/PATH/TO/RELEASE -team-folder NAME
```
