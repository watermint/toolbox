---
layout: command
title: Command `dropbox file tag delete`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file tag delete -path /DROPBOX/PATH/TO/PROCESS -tag TAG_NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file tag delete -path /DROPBOX/PATH/TO/PROCESS -tag TAG_NAME
```
