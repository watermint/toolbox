---
layout: command
title: Command `teamfolder sync setting update`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe teamfolder sync setting update -file /PATH/TO/DATA_FILE.csv
```

macOS, Linux:
```
$HOME/Desktop/tbx teamfolder sync setting update -file /PATH/TO/DATA_FILE.csv
```
