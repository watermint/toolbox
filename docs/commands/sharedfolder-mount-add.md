---
layout: command
title: Command `sharedfolder mount add`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe sharedfolder mount add -shared-folder-id SHARED_FOLDER_ID
```

macOS, Linux:
```
$HOME/Desktop/tbx sharedfolder mount add -shared-folder-id SHARED_FOLDER_ID
```
