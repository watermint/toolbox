---
layout: command
title: Command `google sheets sheet append`
lang: en
---

# google sheets sheet append
...
```
cd $HOME\Desktop
.\tbx.exe google sheets sheet append -data /LOCAL/PATH/TO/INPUT.csv -id GOOGLE_SHEET_ID -range RANGE
```

macOS, Linux:
```
$HOME/Desktop/tbx google sheets sheet append -data /LOCAL/PATH/TO/INPUT.csv -id GOOGLE_SHEET_ID -range RANGE
```
