---
layout: command
title: Command `dropbox file template apply`
lang: en
---
...
| Dropbox: View and edit information about your Dropbox files and folders                              |
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file template apply -path /DROPBOX/PATH/TO/APPLY -template /LOCAL/PATH/TO/template.json
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file template apply -path /DROPBOX/PATH/TO/APPLY -template /LOCAL/PATH/TO/template.json
```
