---
layout: command
title: Command `services google sheets spreadsheet create`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe services google sheets spreadsheet create -title TITLE
```

macOS, Linux:
```
$HOME/Desktop/tbx services google sheets spreadsheet create -title TITLE
```
...
Google Spreadsheet
The command will generate a report in three different formats. `sreadsheet.csv`, `sreadsheet.json`, and `sreadsheet.xlsx`.
...
In case of a report become large, a report in `.xlsx` format will be split into several chunks like follows; `sreadsheet_0000.xlsx`, `sreadsheet_0001.xlsx`, `sreadsheet_0002.xlsx`, ...
