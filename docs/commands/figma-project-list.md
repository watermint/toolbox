---
layout: command
title: Command `figma project list`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe figma project list -team-id TEAM_ID. To obtain a team id, navigate to a team page of a team you are a part of. The team id will be present in the URL after the word team and before your team name.
```

macOS, Linux:
```
$HOME/Desktop/tbx figma project list -team-id TEAM_ID. To obtain a team id, navigate to a team page of a team you are a part of. The team id will be present in the URL after the word team and before your team name.
```
