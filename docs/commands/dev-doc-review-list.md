---
layout: command
title: Command `dev doc review list`
lang: en
---

# dev doc review list

List unreviewed messages 
...
```
cd $HOME\Desktop
.\tbx.exe dev doc review list 
```

macOS, Linux:
```
$HOME/Desktop/tbx dev doc review list 
```
...
**-limit**
: Maximum number of messages to show. Default: 50

**-msg-lang**
: Language. Options: en (msglang: en), ja (msglang: ja). Default: en

**-prefix**
: Filter messages by key prefix
