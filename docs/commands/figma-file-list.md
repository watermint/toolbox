...
```
cd $HOME\Desktop
.\tbx.exe figma file list -project-id PROJECT_ID. Use `services figma project list` command to retrieve PROJECT_IDs on your team.
```

macOS, Linux:
```
$HOME/Desktop/tbx figma file list -project-id PROJECT_ID. Use `services figma project list` command to retrieve PROJECT_IDs on your team.
```
