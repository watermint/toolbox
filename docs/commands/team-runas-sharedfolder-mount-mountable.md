---
layout: command
title: Command `team runas sharedfolder mount mountable`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe team runas sharedfolder mount mountable -member-email EMAIL
```

macOS, Linux:
```
$HOME/Desktop/tbx team runas sharedfolder mount mountable -member-email EMAIL
```
