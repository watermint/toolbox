---
layout: command
title: Command `google mail message processed list`
lang: en
---

# google mail message processed list
...
```
cd $HOME\Desktop
.\tbx.exe google mail message processed list 
```

macOS, Linux:
```
$HOME/Desktop/tbx google mail message processed list 
```
