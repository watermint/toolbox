---
layout: command
title: Command `google mail sendas add`
lang: en
---

# google mail sendas add
...
```
cd $HOME\Desktop
.\tbx.exe google mail sendas add -email EMAIL
```

macOS, Linux:
```
$HOME/Desktop/tbx google mail sendas add -email EMAIL
```
