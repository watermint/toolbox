---
layout: command
title: Command `google sheets sheet clear`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe google sheets sheet clear -id GOOGLE_SPREADSHEET_ID -range RANGE
```

macOS, Linux:
```
$HOME/Desktop/tbx google sheets sheet clear -id GOOGLE_SPREADSHEET_ID -range RANGE
```
