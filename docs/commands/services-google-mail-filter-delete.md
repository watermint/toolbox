---
layout: command
title: Command `services google mail filter delete`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe services google mail filter delete -id ID
```

macOS, Linux:
```
$HOME/Desktop/tbx services google mail filter delete -id ID
```
