---
layout: command
title: Command `team sharedlink delete member`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe team sharedlink delete member -member-email EMAIL
```

macOS, Linux:
```
$HOME/Desktop/tbx team sharedlink delete member -member-email EMAIL
```
