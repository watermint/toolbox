---
layout: command
title: Command `teamspace file list`
lang: en
---

# teamspace file list

List files and folders in team space 
...
```
cd $HOME\Desktop
.\tbx.exe teamspace file list -path /DROPBOX/PATH/TO/LIST
```

macOS, Linux:
```
$HOME/Desktop/tbx teamspace file list -path /DROPBOX/PATH/TO/LIST
```
