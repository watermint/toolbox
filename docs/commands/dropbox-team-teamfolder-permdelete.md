---
layout: command
title: Command `dropbox team teamfolder permdelete`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox team teamfolder permdelete -name TEAMFOLDER_NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox team teamfolder permdelete -name TEAMFOLDER_NAME
```
