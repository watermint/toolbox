---
layout: command
title: Command `services google mail label rename`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe services google mail label rename -current-name CURRENT_NAME -new-name NEW_NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx services google mail label rename -current-name CURRENT_NAME -new-name NEW_NAME
```
