---
layout: command
title: Command `services figma file export node`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe services figma file export node -key FILE_KEY -id NODE_ID -path /LOCAL/PATH/TO/EXPORT
```

macOS, Linux:
```
$HOME/Desktop/tbx services figma file export node -key FILE_KEY -id NODE_ID -path /LOCAL/PATH/TO/EXPORT
```
