---
layout: command
title: Command `dropbox file compare account`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file compare account -left left -left-path /path/to/compare -right right -right-path /path/to/compare
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file compare account -left left -left-path /path/to/compare -right right -right-path /path/to/compare
```
