---
layout: command
title: Command `team sharedlink update password`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe team sharedlink update password -file /PATH/TO/DATA_FILE.csv
```

macOS, Linux:
```
$HOME/Desktop/tbx team sharedlink update password -file /PATH/TO/DATA_FILE.csv
```
