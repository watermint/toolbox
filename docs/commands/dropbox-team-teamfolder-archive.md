---
layout: command
title: Command `dropbox team teamfolder archive`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox team teamfolder archive -name TEAMFOLDER_NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox team teamfolder archive -name TEAMFOLDER_NAME
```
