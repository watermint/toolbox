---
layout: command
title: Command `google mail message label delete`
lang: en
---

# google mail message label delete

Remove labels from the message 
...
```
cd $HOME\Desktop
.\tbx.exe google mail message label delete -label LABEL -message-id MSG_ID
```

macOS, Linux:
```
$HOME/Desktop/tbx google mail message label delete -label LABEL -message-id MSG_ID
```
