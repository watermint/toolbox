---
layout: command
title: Command `teamspace asadmin folder delete`
lang: en
---

# teamspace asadmin folder delete

Delete top level folder of the team space 
...
```
cd $HOME\Desktop
.\tbx.exe teamspace asadmin folder delete -name FOLDER_NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx teamspace asadmin folder delete -name FOLDER_NAME
```
