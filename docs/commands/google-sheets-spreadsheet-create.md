---
layout: command
title: Command `google sheets spreadsheet create`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe google sheets spreadsheet create -title TITLE
```

macOS, Linux:
```
$HOME/Desktop/tbx google sheets spreadsheet create -title TITLE
```
