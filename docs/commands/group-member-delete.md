---
layout: command
title: Command `group member delete`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe group member delete -group-name GROUP_NAME -member-email EMAIL
```

macOS, Linux:
```
$HOME/Desktop/tbx group member delete -group-name GROUP_NAME -member-email EMAIL
```
