...
```
cd $HOME\Desktop
.\tbx.exe dev lifecycle planprune -announce-url URL -compatibility-file /LOCAL/PATH/TO/compat.json -date "2020-04-01 17:58:38" -recipe RECIPE
```

macOS, Linux:
```
$HOME/Desktop/tbx dev lifecycle planprune -announce-url URL -compatibility-file /LOCAL/PATH/TO/compat.json -date "2020-04-01 17:58:38" -recipe RECIPE
```
...
**-compatibility-file**
: Compatibility file. Default: catalogue/catalogue_compatibility.json
