---
layout: command
title: Command `dev lifecycle assets`
lang: en
---

# dev lifecycle assets
...
```
cd $HOME\Desktop
.\tbx.exe dev lifecycle assets 
```

macOS, Linux:
```
$HOME/Desktop/tbx dev lifecycle assets 
```
...
**-days**
: Days to keep. Default: 186

**-owner**
: Repository owner. Default: watermint

**-peer**
: Account alias. Default: default

**-remove**
: Execute remove. Default: false

**-repo**
: Repository name. Default: toolbox
...
The command will generate a report in three different formats. `removed.csv`, `removed.json`, and `removed.xlsx`.
...
In case of a report becomes large, a report in `.xlsx` format will be split into several chunks like follows; `removed_0000.xlsx`, `removed_0001.xlsx`, `removed_0002.xlsx`, ...
