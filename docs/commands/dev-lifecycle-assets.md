...
In case of a report become large, a report in `.xlsx` format will be split into several chunks like follows; `removed_0000.xlsx`, `removed_0001.xlsx`, `removed_0002.xlsx`, ...
