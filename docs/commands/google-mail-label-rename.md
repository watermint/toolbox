---
layout: command
title: Command `google mail label rename`
lang: en
---

# google mail label rename
...
```
cd $HOME\Desktop
.\tbx.exe google mail label rename -current-name CURRENT_NAME -new-name NEW_NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx google mail label rename -current-name CURRENT_NAME -new-name NEW_NAME
```
