---
layout: command
title: Command `sharedfolder leave`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe sharedfolder leave -shared-folder-id SHARED_FOLDER_ID
```

macOS, Linux:
```
$HOME/Desktop/tbx sharedfolder leave -shared-folder-id SHARED_FOLDER_ID
```
