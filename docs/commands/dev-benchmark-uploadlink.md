...
```
cd $HOME\Desktop
.\tbx.exe dev benchmark uploadlink -path /DROPBOX/PATH/TO/UPLOAD -size-kb NUM
```

macOS, Linux:
```
$HOME/Desktop/tbx dev benchmark uploadlink -path /DROPBOX/PATH/TO/UPLOAD -size-kb NUM
```
