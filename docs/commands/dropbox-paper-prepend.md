---
layout: command
title: Command `dropbox paper prepend`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox paper prepend -content /LOCAL/PATH/TO/INPUT.txt -path /DROPBOX/PATH/TO/PREPEND.paper
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox paper prepend -content /LOCAL/PATH/TO/INPUT.txt -path /DROPBOX/PATH/TO/PREPEND.paper
```
