---
layout: command
title: Command `file revision restore`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe file revision restore -path /DROPBOX/PATH/TO/RESTORE -revision REVISION
```

macOS, Linux:
```
$HOME/Desktop/tbx file revision restore -path /DROPBOX/PATH/TO/RESTORE -revision REVISION
```
