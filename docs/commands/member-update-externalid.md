---
layout: command
title: Command `member update externalid`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe member update externalid -file /path/to/file.csv
```

macOS, Linux:
```
$HOME/Desktop/tbx member update externalid -file /path/to/file.csv
```
