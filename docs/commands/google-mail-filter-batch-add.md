---
layout: command
title: Command `google mail filter batch add`
lang: en
---

# google mail filter batch add
...
```
cd $HOME\Desktop
.\tbx.exe google mail filter batch add -file /PATH/TO/DATA_FILE.csv
```

macOS, Linux:
```
$HOME/Desktop/tbx google mail filter batch add -file /PATH/TO/DATA_FILE.csv
```
