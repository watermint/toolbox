---
layout: command
title: Command `dropbox file sharedfolder mount add`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file sharedfolder mount add -shared-folder-id SHARED_FOLDER_ID
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file sharedfolder mount add -shared-folder-id SHARED_FOLDER_ID
```
