...
```
cd $HOME\Desktop
.\tbx.exe file tag add -path /DROPBOX/PATH/TO/TARGET -tag TAG_NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx file tag add -path /DROPBOX/PATH/TO/TARGET -tag TAG_NAME
```
