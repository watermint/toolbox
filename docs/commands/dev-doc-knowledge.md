---
layout: command
title: Command `dev doc knowledge`
lang: en
---

# dev doc knowledge

Generate reduced knowledge base (Experimental)

Generate a reduced-size knowledge base document for LLM training by limiting the number of commands included. This is useful for testing or creating smaller, focused knowledge bases.
...
```
cd $HOME\Desktop
.\tbx.exe dev doc knowledge -command-limit 50 -output-path /LOCAL/PATH/TO/OUTPUT.md
```

macOS, Linux:
```
$HOME/Desktop/tbx dev doc knowledge -command-limit 50 -output-path /LOCAL/PATH/TO/OUTPUT.md
```
...
**-command-limit**
: Maximum number of commands to include (0 for all). Default: 50
