---
layout: command
title: Command `member file lock release`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe member file lock release -member-email VALUE -path /DROPBOX/PATH/TO/RELEASE/LOCK
```

macOS, Linux:
```
$HOME/Desktop/tbx member file lock release -member-email VALUE -path /DROPBOX/PATH/TO/RELEASE/LOCK
```
