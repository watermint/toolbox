---
layout: command
title: Command `services deepl translate text`
lang: en
---
...
For the first run, `tbx` will ask you an authentication with your DeepL account.
...
```
cd $HOME\Desktop
.\tbx.exe services deepl translate text -target-lang TARGET_LANG -text TEXT_TO_TRANSLATE
```

macOS, Linux:
```
$HOME/Desktop/tbx services deepl translate text -target-lang TARGET_LANG -text TEXT_TO_TRANSLATE
```
