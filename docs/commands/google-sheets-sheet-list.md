---
layout: command
title: Command `google sheets sheet list` will be discontinued
lang: en
---

# Command `google sheets sheet list` will be discontinued

The command `google sheets sheet list` will be discontinued.
