---
layout: command
title: Command `team legalhold update name`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe team legalhold update name -name NEW_NAME -policy-id POLICY_ID
```

macOS, Linux:
```
$HOME/Desktop/tbx team legalhold update name -name NEW_NAME -policy-id POLICY_ID
```
