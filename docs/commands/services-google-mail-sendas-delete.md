---
layout: command
title: Command `services google mail sendas delete`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe services google mail sendas delete -email EMAIL
```

macOS, Linux:
```
$HOME/Desktop/tbx services google mail sendas delete -email EMAIL
```
