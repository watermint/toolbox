...
**-block-block-size**
: Block size for batch upload. Default: 24

**-method**
: Upload method. Options: block (Block upload method (parallel chunks)), sequential (Sequential upload method). Default: block

**-num-files**
: Number of files.. Default: 1000
...
**-pre-scan**
: Pre-scan destination path. Default: false

**-seq-chunk-size-kb**
: Upload chunk size in KiB. Default: 65536

**-size-max-kb**
: Maximum file size (KiB).. Default: 2048

**-size-min-kb**
: Minimum file size (KiB).. Default: 0

**-verify**
: Verify after upload. Default: false
