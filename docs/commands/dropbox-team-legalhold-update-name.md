---
layout: command
title: Command `dropbox team legalhold update name`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox team legalhold update name -name NEW_NAME -policy-id POLICY_ID
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox team legalhold update name -name NEW_NAME -policy-id POLICY_ID
```
