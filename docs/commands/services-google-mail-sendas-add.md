---
layout: command
title: Command `services google mail sendas add`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe services google mail sendas add -email EMAIL
```

macOS, Linux:
```
$HOME/Desktop/tbx services google mail sendas add -email EMAIL
```
