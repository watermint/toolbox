---
layout: command
title: Command `services google mail label delete`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe services google mail label delete -name NAME
```

macOS, Linux:
```
$HOME/Desktop/tbx services google mail label delete -name NAME
```
