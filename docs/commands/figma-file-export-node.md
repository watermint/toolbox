---
layout: command
title: Command `figma file export node`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe figma file export node -key FILE_KEY -id NODE_ID -path /LOCAL/PATH/TO/EXPORT
```

macOS, Linux:
```
$HOME/Desktop/tbx figma file export node -key FILE_KEY -id NODE_ID -path /LOCAL/PATH/TO/EXPORT
```
