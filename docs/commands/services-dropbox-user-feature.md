---
layout: command
title: Command `services dropbox user feature`
lang: en
---

# services dropbox user feature

List feature settings for current user 
...
```
cd $HOME\Desktop
.\tbx.exe services dropbox user feature 
```

macOS, Linux:
```
$HOME/Desktop/tbx services dropbox user feature 
```
