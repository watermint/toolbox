---
layout: command
title: Command `dropbox file sharedlink info`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox file sharedlink info -url SHARED_LINK_URL
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox file sharedlink info -url SHARED_LINK_URL
```
