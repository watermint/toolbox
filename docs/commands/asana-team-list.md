...
In case of a report becomes large, a report in `.xlsx` format will be split into several chunks like follows; `teams_0000.xlsx`, `teams_0001.xlsx`, `teams_0002.xlsx`, ...
