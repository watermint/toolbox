---
layout: command
title: Command `dropbox paper create`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe dropbox paper create -content /LOCAL/PATH/TO/INPUT.txt -path /DROPBOX/PATH/TO/CREATE.paper
```

macOS, Linux:
```
$HOME/Desktop/tbx dropbox paper create -content /LOCAL/PATH/TO/INPUT.txt -path /DROPBOX/PATH/TO/CREATE.paper
```
