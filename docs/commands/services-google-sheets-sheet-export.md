---
layout: command
title: Command `services google sheets sheet export`
lang: en
---
...
```
cd $HOME\Desktop
.\tbx.exe services google sheets sheet export -id GOOGLE_SPREADSHEET_ID -range RANGE
```

macOS, Linux:
```
$HOME/Desktop/tbx services google sheets sheet export -id GOOGLE_SPREADSHEET_ID -range RANGE
```
