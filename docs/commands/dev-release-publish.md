...
**-executable-name**
: The name of the executable file to be published.. Default: tbx

**-homebrew-repo-branch**
: The branch of the Homebrew tap repository to use for publishing.. Default: master

**-homebrew-repo-name**
: The name of the Homebrew tap repository.. Default: homebrew-toolbox

**-homebrew-repo-owner**
: The owner of the Homebrew tap repository.. Default: watermint

**-repo-name**
: The name of the repository to publish the release to.. Default: toolbox

**-repo-owner**
: The owner of the repository to publish the release to.. Default: watermint

**-skip-tests**
: Skip end to end tests.. Default: false
