...
  			Desc: strings.Join({
  				"Number of concurrent requests of succes",
+ 				"sful operation",
  				"s",
  			}, ""),
  		},
...
  		"de sharing permissions. The command replicates only",
- 		" for",
  		" folder contents of given path.",
  	}, ""),
...
  	Desc:    "Upon success, the current user will no longer have access to the"...,
  	Remarks: "",
  	... // 20 identical fields
  }
```
...
  	Desc:    "Upon success, the current user cannot access the folder unless a"...,
  	Remarks: "",
  	... // 20 identical fields
  }
```
...
  				"links policies of",
- 				" the",
  				" the team (in case the link's owner is part of a team) and the s",
  				"hared folder (in case the linked file is part of a shared folder",
  				").",
  			}, ""),
  		},
  	},
...
- 	Desc:    "",
+ 	Desc:    "Add a custom tag to a file or folder in Dropbox. Tags help organize and categorize your content for easier searching and management. You can add multiple tags to the same file or folder.",
  	Remarks: "",
...
- 	Desc:    "",
+ 	Desc:    "Remove a specific tag from a file or folder in Dropbox. This operation only removes the tag association and does not affect the file or folder itself. Use this command to clean up outdated or incorrect tags.",
  	Remarks: "",
...
- 	Desc:    "",
+ 	Desc:    "Display all tags associated with a specific file or folder in Dropbox. This command helps you see what tags have been applied to organize and categorize your content. The output shows each tag along with the file path.",
  	Remarks: "",
...
+ 				" that",
  				" are external (not in the same team). Note: Invited members are ",
  				"marked as external member.",
  			}, ""),
  			Default:  "",
  			TypeName: "",
  			TypeAttr: nil,
...
  				"Filter folder members. Keep only members",
+ 				" that",
  				" are internal (in the same team). Note: Invited members are mark",
  				"ed as external member.",
  			}, ""),
  			Default:  "",
  			TypeName: "",
  			TypeAttr: nil,
...
  				"Accept",
- 				" to",
  				" the target release's license agreement",
  			}, ""),
  			Default:  "false",
  			TypeName: "bool",
  			TypeAttr: nil,
