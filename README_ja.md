...
| [file permdelete](doc/generated_ja/file-permdelete.md)                     | Permanently delete the file or folder at a given path. Please see https://www.dropbox.com/help/40 for more detail about permanent deletion. |
